    ...
    <ScrollView style={{height: hp(60)}} bounces={false} showsVerticalScrollIndicator={false} className="space-y-4">
        ...
        <View className="bg-emerald-200 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                ...
                <Text style={{fontSize: wp(5)}} className="font-semibold text-gray-700">ChatGPT</Text>
            </View>
        ...
        <View className="bg-purple-200 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                ...
                <Text style={{fontSize: wp(5)}} className="font-semibold text-gray-700">DALL-E</Text>
            </View>
        ...
        <View className="bg-cyan-200 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                ...
                <Text style={{fontSize: wp(5)}} className="font-semibold text-gray-700">Smart AI</Text>
            </View>
