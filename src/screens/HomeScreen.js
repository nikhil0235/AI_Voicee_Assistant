        ...
        {/* features || message history */}
        {
          messages.length>0? (
            <View className="space-y-2 flex-1 ">
              <Text className="ml-100 text-red-800 font-semibold ml-1 " style={{fontSize: wp(5)}}>Assistant</Text>
              <View 
                style={{height: hp(70)}} 
                        ...
                        if(message.role=='assistant'){
                          ...
                          return (
                            <View key={index} className="flex-row justify-end">
                             <View 
                                key={index} style={{width: wp(70)}} 
                                className="bg-yellow-100 p-2 rounded-xl rounded-tl-none">
                                <Text className="text-neutral-800" style={{fontSize: wp(4)}}  >
                                  {message.content}
                                </Text>
                              </View>
        ...
        <View className="flex justify-center items-center">
          ...
          }
          {
            messages.length>0 && (
              <TouchableOpacity 
                onPress={clear} 
                className="bg-yellow-400 rounded-3xl p-2.5 absolute right-10"
              >
                <Text style={{fontSize:20}} className="text-white font-semibold">Clear</Text>
              </TouchableOpacity>
            )
          }
          {
            speaking && (
              <TouchableOpacity 
                ...
                className="bg-red-600 rounded-3xl p-2.5 absolute left-10"
              >
                <Text  style={{fontSize:20}}className="text-white font-semibold">Stop</Text>
              </TouchableOpacity>
            )
          }
